  ...
  <div className="journal-form">
    ...
    <form>
      <div className="custom-form-block">
        ...
        <input type="text" id="last_name" name="last_name" autoComplete="off" value={currentClient?.last_name ?? "Enter your surname"}
        onChange={handleFieldChange} />
      </div>
      <div className="custom-form-block">
        <label>First name</label>
        <input type="text" id="first_name" name="first_name" autoComplete="off" value={currentClient?.first_name ?? "Enter your name"}
        onChange={handleFieldChange} />
      </div>
      <div className="custom-form-block">
        <label>Father name</label>
        <input type="text" id="father_name" name="father_name" autoComplete="off" value={currentClient?.father_name ?? "Enter your father's name"} onChange={handleFieldChange} />
      </div>
      <div className="custom-form-block">
        <label>Passport seria</label>
        <input type="number" id="passport_seria" name="passport_seria" autoComplete="off"
        value={currentClient?.passport_seria ?? "Enter passport seria"} onChange={handleFieldChange} />
      </div>
      <div className="custom-form-block">
        <label>Passport number</label>
        <input type="number" id="passport_num" name="passport_num" autoComplete="off"
        value={currentClient?.passport_num ?? "Enter your pasport number"} onChange={handleFieldChange}/>
      </div>
    </form>
